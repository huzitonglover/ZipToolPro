...
public struct SevenZipCompressionOptions: Sendable {
    ...
    /// Raw archive format name understood by 7-Zip. Overrides `format` when set.
    public var rawFormatName: String?
    ...
    public init(
        ...
        self.format = format
        self.rawFormatName = rawFormatName
        self.level = level
        self.method = method
