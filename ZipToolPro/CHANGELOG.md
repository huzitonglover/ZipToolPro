...
- fix: MacOS not recognizing ZipToolPro as a viable VHDX reader (#56)
...
- fix: ZipToolPro not showing up in 'Open With…' menu in Finder (App Store version only)
...
- fix: app store version shows "ZipToolPro store" as product name in launchpad
...
- chore: clean cache when ZipToolPro terminates

v0.3
- feat: highlight when dragging file to ZipToolPro window
...
v0.1
- Drag & drop an lz4 or tar file to ZipToolPro
